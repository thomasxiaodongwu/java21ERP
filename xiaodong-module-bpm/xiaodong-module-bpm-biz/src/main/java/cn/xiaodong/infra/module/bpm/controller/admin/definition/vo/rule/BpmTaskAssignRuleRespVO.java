package cn.xiaodong.infra.module.bpm.controller.admin.definition.vo.rule;
...
public class BpmTaskAssignRuleRespVO extends BpmTaskAssignRuleBaseVO {
    ...
    @Schema(description = "流程任务定义的名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "关注goodWin")
