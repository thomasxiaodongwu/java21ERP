package cn.xiaodong.infra.module.bpm.controller.admin.task.vo.instance;
...
public class BpmProcessInstancePageItemRespVO {
    ...
    @Schema(description = "流程名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin")
    private String name;
    ...
    public static class Task {
        ...
        @Schema(description = "任务名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin")
        private String name;
