...
import cn.xiaodong.infra.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static cn.xiaodong.infra.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("goodWin")));
       // 测试 status 不匹配
