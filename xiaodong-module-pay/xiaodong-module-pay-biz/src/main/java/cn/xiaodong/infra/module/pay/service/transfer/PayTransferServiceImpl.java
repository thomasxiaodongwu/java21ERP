package cn.xiaodong.infra.module.pay.service.transfer;
...
import cn.xiaodong.infra.framework.pay.core.enums.transfer.PayTransferStatusRespEnum;
...
import cn.xiaodong.infra.module.pay.controller.admin.transfer.vo.PayTransferSubmitReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.transfer.vo.PayTransferSubmitRespVO;
import cn.xiaodong.infra.module.pay.convert.transfer.PayTransferConvert;
...
import cn.xiaodong.infra.module.pay.dal.mysql.transfer.PayTransferExtensionMapper;
import cn.xiaodong.infra.module.pay.dal.mysql.transfer.PayTransferMapper;
import cn.xiaodong.infra.module.pay.dal.redis.no.PayNoRedisDAO;
import cn.xiaodong.infra.module.pay.enums.transfer.PayTransferStatusEnum;
...
public class PayTransferServiceImpl implements PayTransferService {
    ...
    public PayTransferSubmitRespVO submitTransfer(PayTransferSubmitReqVO reqVO, String userIp) {
        ...
        if (StrUtil.isNotEmpty(unifiedTransferResp.getChannelErrorCode())) {
            throw exception(ErrorCodeConstants.PAY_TRANSFER_SUBMIT_CHANNEL_ERROR, unifiedTransferResp.getChannelErrorCode(),
