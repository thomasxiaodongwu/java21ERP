package cn.xiaodong.infra.module.pay.service.app;
...
import cn.xiaodong.infra.module.pay.controller.admin.app.vo.PayAppCreateReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.app.vo.PayAppPageReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.app.vo.PayAppUpdateReqVO;
import cn.xiaodong.infra.module.pay.dal.dataobject.app.PayAppDO;
import cn.xiaodong.infra.module.pay.dal.mysql.app.PayAppMapper;
...
public class PayAppServiceTest extends BaseDbUnitTest {
    ...
    public void testUpdateApp_notExists() {
        ...
        PayAppUpdateReqVO reqVO = randomPojo(PayAppUpdateReqVO.class, o ->
                o.setStatus((RandomUtil.randomEle(CommonStatusEnum.values()).getStatus())));
        // 调用, 并断言异常
        assertServiceException(() -> appService.updateApp(reqVO), ErrorCodeConstants.APP_NOT_FOUND);
    }
    ...
    public void testDeleteApp_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> appService.deleteApp(id), ErrorCodeConstants.APP_NOT_FOUND);
    }
    ...
    public void testDeleteApp_existOrder() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> appService.deleteApp(id), ErrorCodeConstants.APP_EXIST_ORDER_CANT_DELETE);
    }
    ...
    public void testDeleteApp_existRefund() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> appService.deleteApp(id), ErrorCodeConstants.APP_EXIST_REFUND_CANT_DELETE);
    }
    ...
    public void testValidPayApp_notFound() {
        assertServiceException(() -> appService.validPayApp(randomLongId()), ErrorCodeConstants.APP_NOT_FOUND);
    }
    ...
    public void testValidPayApp_disable() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> appService.validPayApp(id), ErrorCodeConstants.APP_IS_DISABLE);
    }
