package cn.xiaodong.infra.module.pay.service.refund;
...
import cn.xiaodong.infra.framework.pay.core.client.dto.refund.PayRefundUnifiedReqDTO;
import cn.xiaodong.infra.framework.pay.core.enums.channel.PayChannelEnum;
import cn.xiaodong.infra.framework.pay.core.enums.refund.PayRefundStatusRespEnum;
import cn.xiaodong.infra.framework.test.core.ut.BaseDbAndRedisUnitTest;
import cn.xiaodong.infra.module.pay.api.refund.dto.PayRefundCreateReqDTO;
import cn.xiaodong.infra.module.pay.controller.admin.refund.vo.PayRefundExportReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.refund.vo.PayRefundPageReqVO;
...
import cn.xiaodong.infra.module.pay.dal.dataobject.refund.PayRefundDO;
import cn.xiaodong.infra.module.pay.dal.mysql.refund.PayRefundMapper;
...
import cn.xiaodong.infra.module.pay.enums.refund.PayRefundStatusEnum;
...
import static cn.xiaodong.infra.framework.test.core.util.RandomUtils.randomPojo;
import static cn.xiaodong.infra.framework.test.core.util.RandomUtils.randomString;
...
public class PayRefundServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateRefund_channelNotFound() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> refundService.createPayRefund(reqDTO),
                ErrorCodeConstants.CHANNEL_NOT_FOUND);
    }
    ...
    public void testCreateRefund_refundExists() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> refundService.createPayRefund(reqDTO),
                ErrorCodeConstants.REFUND_EXISTS);
    }
    ...
    public void testNotifyRefundSuccess_notFound() {
        ...
        assertServiceException(() -> refundService.notifyRefund(channel, refundRespDTO),
                ErrorCodeConstants.REFUND_NOT_FOUND);
    }
    ...
    public void testNotifyRefundSuccess_failure() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> refundService.notifyRefund(channel, refundRespDTO),
                ErrorCodeConstants.REFUND_STATUS_IS_NOT_WAITING);
    }
    ...
    public void testNotifyRefundSuccess_success() {
        ...
        verify(notifyService).createPayNotifyTask(ArgumentMatchers.eq(PayNotifyTypeEnum.REFUND.getType()),
                eq(refund.getId()));
    }
