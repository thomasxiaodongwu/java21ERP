package cn.xiaodong.infra.module.pay.service.order;
...
import cn.xiaodong.infra.framework.pay.core.enums.channel.PayChannelEnum;
import cn.xiaodong.infra.framework.pay.core.enums.order.PayOrderDisplayModeEnum;
import cn.xiaodong.infra.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import cn.xiaodong.infra.framework.test.core.ut.BaseDbAndRedisUnitTest;
import cn.xiaodong.infra.module.pay.api.order.dto.PayOrderCreateReqDTO;
import cn.xiaodong.infra.module.pay.controller.admin.order.vo.PayOrderExportReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.order.vo.PayOrderPageReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.order.vo.PayOrderSubmitReqVO;
import cn.xiaodong.infra.module.pay.controller.admin.order.vo.PayOrderSubmitRespVO;
...
import cn.xiaodong.infra.module.pay.dal.dataobject.order.PayOrderExtensionDO;
import cn.xiaodong.infra.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import cn.xiaodong.infra.module.pay.dal.mysql.order.PayOrderMapper;
import cn.xiaodong.infra.module.pay.dal.redis.no.PayNoRedisDAO;
import cn.xiaodong.infra.module.pay.enums.notify.PayNotifyTypeEnum;
import cn.xiaodong.infra.module.pay.enums.order.PayOrderStatusEnum;
import cn.xiaodong.infra.module.pay.framework.pay.config.PayProperties;
...
import static cn.xiaodong.infra.framework.common.util.date.LocalDateTimeUtils.*;
import static cn.xiaodong.infra.framework.common.util.json.JsonUtils.toJsonString;
import static cn.xiaodong.infra.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.xiaodong.infra.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.xiaodong.infra.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.xiaodong.infra.framework.test.core.util.RandomUtils.*;
...
public class PayOrderServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testSubmitOrder_notFound() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> orderService.submitOrder(reqVO, userIp), ErrorCodeConstants.PAY_ORDER_NOT_FOUND);
    }
    ...
    public void testSubmitOrder_notWaiting() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> orderService.submitOrder(reqVO, userIp), ErrorCodeConstants.PAY_ORDER_STATUS_IS_NOT_WAITING);
    }
    ...
    public void testSubmitOrder_isSuccess() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> orderService.submitOrder(reqVO, userIp), ErrorCodeConstants.PAY_ORDER_STATUS_IS_SUCCESS);
    }
    ...
    public void testSubmitOrder_expired() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> orderService.submitOrder(reqVO, userIp), ErrorCodeConstants.PAY_ORDER_IS_EXPIRED);
    }
    ...
    public void testSubmitOrder_channelNotFound() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> orderService.submitOrder(reqVO, userIp), ErrorCodeConstants.CHANNEL_NOT_FOUND);
    }
    ...
    public void testSubmitOrder_channelError() {
        ...
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            assertServiceException(() -> orderService.submitOrder(reqVO, userIp),
                    ErrorCodeConstants.PAY_ORDER_SUBMIT_CHANNEL_ERROR, "001", "模拟异常");
    ...
    public void testValidateOrderActuallyPaid_dbPaid() {
        ...
        assertServiceException(() -> orderService.validateOrderActuallyPaid(id),
                ErrorCodeConstants.PAY_ORDER_EXTENSION_IS_PAID);
    }
    ...
    public void testNotifyOrderSuccess_orderExtension_notFound() {
        ...
        assertServiceException(() -> orderService.notifyOrder(channel, notify),
                ErrorCodeConstants.PAY_ORDER_EXTENSION_NOT_FOUND);
    }
    ...
    public void testNotifyOrderSuccess_orderExtension_closed() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.notifyOrder(channel, notify),
                ErrorCodeConstants.PAY_ORDER_EXTENSION_STATUS_IS_NOT_WAITING);
    }
    ...
    public void testNotifyOrderSuccess_order_notFound() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.notifyOrder(channel, notify),
                ErrorCodeConstants.PAY_ORDER_NOT_FOUND);
    ...
    private void testNotifyOrderSuccess_order_closedOrRefund(Integer status) {
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.notifyOrder(channel, notify),
                ErrorCodeConstants.PAY_ORDER_STATUS_IS_NOT_WAITING);
    ...
    public void testNotifyOrderSuccess_order_waiting() {
        ...
        assertPojoEquals(order, orderMapper.selectOne(null),
                "updateTime", "updater");
        // 断言，调用
        verify(notifyService).createPayNotifyTask(ArgumentMatchers.eq(PayNotifyTypeEnum.ORDER.getType()),
    ...
    private void testUpdateOrderRefundPrice_waitingOrClosed(Integer status) {
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.updateOrderRefundPrice(id, incrRefundPrice),
                ErrorCodeConstants.PAY_ORDER_REFUND_FAIL_STATUS_ERROR);
    }
    ...
    public void testUpdateOrderRefundPrice_priceExceed() {
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.updateOrderRefundPrice(id, incrRefundPrice),
                ErrorCodeConstants.REFUND_PRICE_EXCEED);
    }
