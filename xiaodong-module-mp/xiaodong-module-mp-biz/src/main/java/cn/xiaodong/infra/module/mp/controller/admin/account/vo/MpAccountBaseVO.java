package cn.xiaodong.infra.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin")
    ...
    @Schema(description = "备注", example = "请关注goodWin，学习技术")
