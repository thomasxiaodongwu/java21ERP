package cn.xiaodong.infra.module.member.api.address.dto;
...
public class MemberAddressRespDTO {
    ...
    @Schema(description = "收件人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin")
    private String name;
    ...
    @Schema(description = "收件详细地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin 88 小区 106 号")
