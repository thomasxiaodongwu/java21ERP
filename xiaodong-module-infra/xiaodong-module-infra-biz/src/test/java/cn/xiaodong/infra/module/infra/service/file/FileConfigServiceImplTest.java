package cn.xiaodong.infra.module.infra.service.file;
...
import cn.xiaodong.infra.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
...
import cn.xiaodong.infra.module.infra.dal.mysql.file.FileConfigMapper;
...
import cn.xiaodong.infra.module.infra.framework.file.core.enums.FileStorageEnum;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("goodWin")
