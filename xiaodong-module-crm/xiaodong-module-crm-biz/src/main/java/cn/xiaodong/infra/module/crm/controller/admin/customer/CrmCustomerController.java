package cn.xiaodong.infra.module.crm.controller.admin.customer;
...
import cn.xiaodong.infra.framework.excel.core.enums.ExcelColumn;
...
import cn.xiaodong.infra.module.crm.service.customer.CrmCustomerPoolConfigService;
...
import static cn.xiaodong.infra.module.crm.enums.DictTypeConstants.*;
...
public class CrmCustomerController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<CrmCustomerImportExcelVO> list = Arrays.asList(
                CrmCustomerImportExcelVO.builder().name("goodWin").industryId(1).level(1).source(1)
