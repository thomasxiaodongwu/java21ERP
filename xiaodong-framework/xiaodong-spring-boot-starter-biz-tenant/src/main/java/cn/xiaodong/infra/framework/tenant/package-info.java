 ...
 *      1）Spring Async：
 *          {@link cn.xiaodong.infra.framework.quartz.config.YudaoAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 ...
 *
 */
package cn.xiaodong.infra.framework.tenant;
