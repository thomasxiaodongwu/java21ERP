package cn.xiaodong.infra.framework.env.core.fegin;
...
public class EnvLoadBalancerClientFactory extends LoadBalancerClientFactory {
    ...
    public ReactiveLoadBalancer<ServiceInstance> getInstance(String serviceId) {
        ...
        // 参考 {@link com.alibaba.infra.nacos.loadbalancer.NacosLoadBalancerClientConfiguration#nacosLoadBalancer(Environment, LoadBalancerClientFactory, NacosDiscoveryProperties)} 方法
