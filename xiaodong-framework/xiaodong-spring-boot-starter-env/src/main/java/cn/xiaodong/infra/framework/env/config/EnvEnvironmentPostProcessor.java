package cn.xiaodong.infra.framework.env.config;

import cn.hutool.core.util.StrUtil;
import cn.xiaodong.infra.framework.common.util.collection.SetUtils;
import cn.xiaodong.infra.framework.env.core.util.EnvUtils;
...
import static cn.xiaodong.infra.framework.env.core.util.EnvUtils.HOST_NAME_VALUE;
...
public class EnvEnvironmentPostProcessor implements EnvironmentPostProcessor {
    ...
    private static final Set<String> TARGET_TAG_KEYS = SetUtils.asSet(
            "spring.infra.nacos.discovery.metadata.tag" // Nacos 注册中心
            // MQ TODO
    );
