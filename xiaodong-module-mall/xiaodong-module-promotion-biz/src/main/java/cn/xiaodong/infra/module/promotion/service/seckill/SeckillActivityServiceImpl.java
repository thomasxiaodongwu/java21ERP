package cn.xiaodong.infra.module.promotion.service.seckill;
...
import cn.xiaodong.infra.module.promotion.api.seckill.dto.SeckillValidateJoinRespDTO;
import cn.xiaodong.infra.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityCreateReqVO;
import cn.xiaodong.infra.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityPageReqVO;
import cn.xiaodong.infra.module.promotion.controller.admin.seckill.vo.activity.SeckillActivityUpdateReqVO;
import cn.xiaodong.infra.module.promotion.controller.admin.seckill.vo.product.SeckillProductBaseVO;
import cn.xiaodong.infra.module.promotion.controller.app.seckill.vo.activity.AppSeckillActivityPageReqVO;
import cn.xiaodong.infra.module.promotion.convert.seckill.seckillactivity.SeckillActivityConvert;
import cn.xiaodong.infra.module.promotion.dal.dataobject.seckill.SeckillActivityDO;
import cn.xiaodong.infra.module.promotion.dal.dataobject.seckill.SeckillConfigDO;
import cn.xiaodong.infra.module.promotion.dal.dataobject.seckill.SeckillProductDO;
import cn.xiaodong.infra.module.promotion.dal.mysql.seckill.seckillactivity.SeckillActivityMapper;
import cn.xiaodong.infra.module.promotion.dal.mysql.seckill.seckillactivity.SeckillProductMapper;
...
import static cn.xiaodong.infra.framework.common.util.date.LocalDateTimeUtils.isBetween;
...
public class SeckillActivityServiceImpl implements SeckillActivityService {
    ...
    private void validateProductExists(Long spuId, List<SeckillProductBaseVO> products) {
        ...
        if (spu == null) {
            throw ServiceExceptionUtil.exception(cn.xiaodong.infra.module.product.enums.ErrorCodeConstants.SPU_NOT_EXISTS);
        }
        ...
        products.forEach(product -> {
            if (!skuMap.containsKey(product.getSkuId())) {
                throw ServiceExceptionUtil.exception(cn.xiaodong.infra.module.product.enums.ErrorCodeConstants.SKU_NOT_EXISTS);
            }
        });
    }
