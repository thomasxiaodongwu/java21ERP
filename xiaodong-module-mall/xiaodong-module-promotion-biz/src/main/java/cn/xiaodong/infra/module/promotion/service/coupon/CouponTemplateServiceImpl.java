package cn.xiaodong.infra.module.promotion.service.coupon;
...
import cn.xiaodong.infra.module.promotion.controller.admin.coupon.vo.template.CouponTemplateCreateReqVO;
import cn.xiaodong.infra.module.promotion.controller.admin.coupon.vo.template.CouponTemplatePageReqVO;
import cn.xiaodong.infra.module.promotion.controller.admin.coupon.vo.template.CouponTemplateUpdateReqVO;
import cn.xiaodong.infra.module.promotion.convert.coupon.CouponTemplateConvert;
import cn.xiaodong.infra.module.promotion.dal.dataobject.coupon.CouponTemplateDO;
import cn.xiaodong.infra.module.promotion.dal.mysql.coupon.CouponTemplateMapper;
import cn.xiaodong.infra.module.promotion.enums.common.PromotionProductScopeEnum;
import cn.xiaodong.infra.module.promotion.enums.coupon.CouponTakeTypeEnum;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public void updateCouponTemplate(CouponTemplateUpdateReqVO updateReqVO) {
        ...
        if (updateReqVO.getTotalCount() < couponTemplate.getTakeCount()) {
            throw exception(ErrorCodeConstants.COUPON_TEMPLATE_TOTAL_COUNT_TOO_SMALL, couponTemplate.getTakeCount());
        }
        // 校验商品范围
