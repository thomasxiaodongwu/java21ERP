package cn.xiaodong.infra.module.product.service.spu;
...
import cn.xiaodong.infra.module.product.controller.admin.spu.vo.ProductSkuSaveReqVO;
import cn.xiaodong.infra.module.product.controller.admin.spu.vo.ProductSpuPageReqVO;
import cn.xiaodong.infra.module.product.controller.admin.spu.vo.ProductSpuSaveReqVO;
import cn.xiaodong.infra.module.product.controller.admin.spu.vo.ProductSpuUpdateStatusReqVO;
...
import cn.xiaodong.infra.module.product.dal.mysql.spu.ProductSpuMapper;
import cn.xiaodong.infra.module.product.enums.spu.ProductSpuStatusEnum;
import cn.xiaodong.infra.module.product.service.brand.ProductBrandService;
...
import static cn.xiaodong.infra.module.product.dal.dataobject.category.ProductCategoryDO.CATEGORY_LEVEL;
    ...
    public List<ProductSpuDO> validateSpuList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!ProductSpuStatusEnum.isEnable(spu.getStatus())) {
                throw exception(ErrorCodeConstants.SPU_NOT_ENABLE, spu.getName());
            }
        });
        return list;
    }
