package cn.xiaodong.infra.module.product.service.category;
...
import cn.xiaodong.infra.module.product.controller.admin.category.vo.ProductCategorySaveReqVO;
import cn.xiaodong.infra.module.product.dal.dataobject.category.ProductCategoryDO;
import cn.xiaodong.infra.module.product.dal.mysql.category.ProductCategoryMapper;
...
import static cn.xiaodong.infra.module.product.dal.dataobject.category.ProductCategoryDO.PARENT_ID_NULL;
    ...
    public void validateCategoryList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!CommonStatusEnum.ENABLE.getStatus().equals(category.getStatus())) {
                throw exception(ErrorCodeConstants.CATEGORY_DISABLED, category.getName());
            }
        });
    }
