package cn.xiaodong.infra.module.system.api.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @Schema(description = "Java 方法名", requiredMode = Schema.RequiredMode.REQUIRED, example = "cn.xiaodong.infra.UserController.save(...)")
