package cn.xiaodong.infra.module.system.service.tenant;
...
import cn.xiaodong.infra.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import cn.xiaodong.infra.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import cn.xiaodong.infra.module.system.dal.dataobject.permission.MenuDO;
import cn.xiaodong.infra.module.system.dal.dataobject.permission.RoleDO;
import cn.xiaodong.infra.module.system.dal.dataobject.tenant.TenantDO;
import cn.xiaodong.infra.module.system.dal.dataobject.tenant.TenantPackageDO;
import cn.xiaodong.infra.module.system.dal.mysql.tenant.TenantMapper;
import cn.xiaodong.infra.module.system.enums.permission.RoleCodeEnum;
import cn.xiaodong.infra.module.system.enums.permission.RoleTypeEnum;
import cn.xiaodong.infra.module.system.service.permission.MenuService;
import cn.xiaodong.infra.module.system.service.permission.PermissionService;
import cn.xiaodong.infra.module.system.service.permission.RoleService;
import cn.xiaodong.infra.module.system.service.tenant.handler.TenantInfoHandler;
import cn.xiaodong.infra.module.system.service.tenant.handler.TenantMenuHandler;
...
import static cn.xiaodong.infra.framework.common.util.collection.SetUtils.asSet;
...
import static cn.xiaodong.infra.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static cn.xiaodong.infra.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("goodWin", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("goodWin"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("goodWin");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
