package cn.xiaodong.infra.module.system.service.mail;
...
import cn.xiaodong.infra.module.system.controller.admin.mail.vo.template.MailTemplatePageReqVO;
import cn.xiaodong.infra.module.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import cn.xiaodong.infra.module.system.dal.dataobject.mail.MailTemplateDO;
import cn.xiaodong.infra.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static cn.xiaodong.infra.framework.test.core.util.RandomUtils.randomLongId;
import static cn.xiaodong.infra.framework.test.core.util.RandomUtils.randomPojo;
import static cn.xiaodong.infra.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("goodWin")));
        // 测试 code 不匹配
