package cn.xiaodong.infra.module.erp.controller.admin.stock.vo.out;
...
import static cn.xiaodong.infra.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockOutRespVO {
    ...
    @Schema(description = "客户名称", example = "goodWin")
    @ExcelProperty("客户名称")
    ...
    @Schema(description = "创建人", example = "goodWin")
    private String creator;
    @Schema(description = "创建人名称", example = "goodWin")
