package cn.xiaodong.infra.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "goodWin")
    @ExcelProperty("供应商名称")
    private String name;
